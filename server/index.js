...
app.get("/login", (req, res) => {
  ...
  req.session.state = state; // Save state in session for later verification
...
app.get("/callback", async (req, res) => {
  // Logik för att hantera callback från Spotify
  ...
  try {
    ...
    try {
      ...
      res.redirect(`${process.env.FRONTEND_URL}/loggedIn#token=${sessionToken}`);
    } catch (error) {
